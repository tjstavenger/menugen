 ...
 * @author tstavenger
 */
public class MenuGenFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				...
				toolBar, javax.swing.GroupLayout.DEFAULT_SIZE, 400,
				Short.MAX_VALUE).addComponent(contentsScrollPane,
	...
	private void newRecipeButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_newRecipeButtonActionPerformed
		contentsScrollPane.getViewport().removeAll();
		contentsScrollPane.getViewport().add(new RecipePanel());
		repaint();
	}// GEN-LAST:event_newRecipeButtonActionPerformed

	private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_searchButtonActionPerformed
		contentsScrollPane.getViewport().removeAll();
		contentsScrollPane.getViewport().add(new SearchPanel());
		repaint();
